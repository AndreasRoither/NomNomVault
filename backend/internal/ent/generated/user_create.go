...
func (_c *UserCreate) AddMemberships(v ...*HouseholdMember) *UserCreate {
...
func (_c *UserCreate) AddRecipeShareIDs(ids ...string) *UserCreate {
	_c.mutation.AddRecipeShareIDs(ids...)
	return _c
}

// AddRecipeShares adds the "recipe_shares" edges to the RecipeShare entity.
func (_c *UserCreate) AddRecipeShares(v ...*RecipeShare) *UserCreate {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.RecipeSharesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
