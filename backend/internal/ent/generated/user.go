...
func (e UserEdges) MembershipsOrErr() ([]*HouseholdMember, error) {
	if e.loadedTypes[0] {
...
// RecipeSharesOrErr returns the RecipeShares value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) RecipeSharesOrErr() ([]*RecipeShare, error) {
	if e.loadedTypes[1] {
		return e.RecipeShares, nil
	}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldDisplayName, user.FieldEmail, user.FieldPasswordHash, user.FieldRole:
...
func (_m *User) QueryMemberships() *HouseholdMemberQuery {
