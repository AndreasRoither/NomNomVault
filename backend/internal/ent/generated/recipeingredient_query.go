...
func (_q *RecipeIngredientQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *RecipeIngredientQuery) FirstIDX(ctx context.Context) string {
...
func (_q *RecipeIngredientQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *RecipeIngredientQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *RecipeIngredientQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *RecipeIngredientQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(recipeingredient.FieldCreatedAt).
...
//
//	client.RecipeIngredient.Query().
//		Select(recipeingredient.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *RecipeIngredientQuery) loadRecipe(ctx context.Context, query *RecipeQuery, nodes []*RecipeIngredient, init func(*RecipeIngredient), assign func(*RecipeIngredient, *Recipe)) error {
	...
	nodeids := make(map[string][]*RecipeIngredient)
	for i := range nodes {
		fk := nodes[i].RecipeID
...
func (_q *RecipeIngredientQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(recipeingredient.Table, recipeingredient.Columns, sqlgraph.NewFieldSpec(recipeingredient.FieldID, field.TypeString))
	_spec.From = _q.sql
