...
func (_c *RefreshSessionCreate) SetRevoked(v bool) *RefreshSessionCreate {
	_c.mutation.SetRevoked(v)
	return _c
}

// SetNillableRevoked sets the "revoked" field if the given value is not nil.
func (_c *RefreshSessionCreate) SetNillableRevoked(v *bool) *RefreshSessionCreate {
	if v != nil {
		_c.SetRevoked(*v)
	}
	return _c
...
func (_c *RefreshSessionCreate) SetDeviceInfo(v string) *RefreshSessionCreate {
	_c.mutation.SetDeviceInfo(v)
	return _c
}

// SetNillableDeviceInfo sets the "device_info" field if the given value is not nil.
func (_c *RefreshSessionCreate) SetNillableDeviceInfo(v *string) *RefreshSessionCreate {
	if v != nil {
		_c.SetDeviceInfo(*v)
	}
	return _c
...
func (_c *RefreshSessionCreate) SetIPAddress(v string) *RefreshSessionCreate {
	_c.mutation.SetIPAddress(v)
	return _c
}

// SetNillableIPAddress sets the "ip_address" field if the given value is not nil.
func (_c *RefreshSessionCreate) SetNillableIPAddress(v *string) *RefreshSessionCreate {
	if v != nil {
		_c.SetIPAddress(*v)
	}
	return _c
...
func (_c *RefreshSessionCreate) defaults() {
	...
	if _, ok := _c.mutation.Revoked(); !ok {
		v := refreshsession.DefaultRevoked
		_c.mutation.SetRevoked(v)
	}
...
func (_c *RefreshSessionCreate) check() error {
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "RefreshSession.updated_at"`)}
	}
	...
	if _, ok := _c.mutation.Revoked(); !ok {
		return &ValidationError{Name: "revoked", err: errors.New(`generated: missing required field "RefreshSession.revoked"`)}
	}
